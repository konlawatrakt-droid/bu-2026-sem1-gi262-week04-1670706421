...
namespace Assignment
{
    public class Assignment : MonoBehaviour
    {
        ...
        public void AS01_CountWords()
        {
            ...
            string[] keys = new string[wordCounts.Keys.Count];
            wordCounts.Keys.CopyTo(keys, 0);

            int[] values = new int[wordCounts.Values.Count];
        ...
        public void AS02_CountNumber()
        {
            ...
            int[] keys = new int[numberCounts.Keys.Count];
            numberCounts.Keys.CopyTo(keys, 0);

            int[] values = new int[numberCounts.Values.Count];
